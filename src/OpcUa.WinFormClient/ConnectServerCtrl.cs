...
namespace TongFang.OpcUa.Client
{
    public partial class ConnectServerCtrl : UserControl
    {
        ...
        public Session Connect()
        {
            ...
            EndpointDescription endpointDescription = ClientHelper.SelectEndpoint(serverUrl, UseSecurityCK.Checked);
        ...
        private EndpointDescription SelectEndpoint()
        {
            try
            {
                ...
                return ClientHelper.SelectEndpoint(discoveryUrl, UseSecurityCK.Checked);
            }
            finally
            {
